defmodule Engine.ImageConfig do
  @moduledoc """
  Provides struct and type for a ImageConfig
  """
  ...
  @type t :: %__MODULE__{
          ...
          Env: [String.t()] | nil,
          ExposedPorts: Engine.ImageConfigExposedPorts.t() | nil,
          Healthcheck: Engine.HealthConfig.t() | nil,
          Hostname: String.t() | nil,
          Image: String.t() | nil,
          Labels: Engine.ImageConfigLabels.t() | nil,
          ...
          Tty: boolean | nil,
          User: String.t() | nil,
          Volumes: Engine.ImageConfigVolumes.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      Env: [string: :generic],
      ExposedPorts: {Engine.ImageConfigExposedPorts, :t},
      Healthcheck: {Engine.HealthConfig, :t},
      Hostname: {:string, :generic},
      Image: {:string, :generic},
      Labels: {Engine.ImageConfigLabels, :t},
      ...
      Tty: :boolean,
      User: {:string, :generic},
      Volumes: {Engine.ImageConfigVolumes, :t},
